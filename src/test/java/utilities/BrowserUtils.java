...
public class BrowserUtils {
    ...
    /*
    Method that will accept dropDown WebElement and value of that dropdown,
    and it will select that value which is provided in parameter.
    Ex:
    ...
    /*
    This method will wait til element is clickable.
    Ex:
